        ...
        while (line != null && !line.equals("6")) {
            switch (line){
                ...
                case "2": 
                    ...
                    if (mostSuitableHost != null) {
                        System.out.println("Most suitable host: " + mostSuitableHost.toString());
                    } else {
                ...
                case "3": 
                    ...
                    // You can use the SymbioteHost toString() method when printing, to get a 
                    // host's info as a string
                    ArrayList<SymbioteHost> suitableHosts = test.findHostsWithinSuitabilityRange(min, max);
                    if (suitableHosts != null && !suitableHosts.isEmpty()) {
                        for (SymbioteHost host : suitableHosts) {
                            System.out.println(host);
                        }
                    } else {
                        System.out.println("No hosts found within this suitability range.");
                    }
                    break;
